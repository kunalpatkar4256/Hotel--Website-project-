      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            ...
            <img src="images/shangrila1.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            <h2 class="heading">City Staycation</h2>
            <p class="mb-4"> Enjoy greater benefits on your city staycation in Colombo including complimentary breakfast, food and beverage credit and more.</p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            ...
            <img src="images/shangrila2.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            <h2 class="heading">The Suite Life?</h2>
            <p class="mb-4"> Enjoy access to Adventure Zone, a fun and immersive indoor play space
                for kids both based at One Galle Face Mall.?</p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            ...
            <img src="images/shangrila3.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            ...
            <p><span class="d-block"><span class="ion-ios-email h5 mr-3 text-primary"></span>Email:</span> <span> shangri-lahotel@gmail.com</span></p>
          </div>
          <div class="col-md-3 mb-5">
