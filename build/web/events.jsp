        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wedding1.jpg" alt="Image placeholder" class="img-fluid" ></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed1.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
              
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed2.jpg" alt="Image placeholder" class="img-fluid" width="640" height="480"></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed3.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
              
            </div>
          </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed4.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed9.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
              
            </div>
          </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed7.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
              
            </div>
          </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wedding1.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/wed6.jpg" width="640" height="480" alt="Image placeholder" class="img-fluid"></a>
     ...
     <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            ...
            <p><span class="d-block"><span class="ion-ios-email h5 mr-3 text-primary"></span>Email:</span> <span> shangri_lahotel@gmail.com</span></p>
          </div>
          <div class="col-md-3 mb-5">
